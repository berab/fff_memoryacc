...
class TrainMoEGrid(BaseTrainExp):
    def __init__(self):
    ...
    def run_exp(self) -> dict:
        ...
        for epoch in range(self.epochs):
            train_loss, train_acc, reg_loss, entropy_loss = moe_train_epoch(self.model, self.optim, self.loader.train, self.criterion, epoch, self.device, self.reg_alpha, self.entropy_alpha)
